...
public class StationeryCrawler {
  ...
  private static final String url_list = "http://123.57.18.218/goodslist-1-0-{0}-0-0-0-null";
...
//      put("param", "#param ^ text");
  ...
  @Test
  public void prase() {
    System.out.println(praseDetail("/goods-32289"));
  }
  ...
  public static List praseMainList() {
    ...
    try {
      ...
      } while (mainList != null && !mainList.isEmpty() && pageNo < 30);
    } catch (IOException e) {
      e.printStackTrace();
    }
    return result;
