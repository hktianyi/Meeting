...
public class AttendeeCtrl extends BaseCtrl<MeetingAttendee> {
  ...
  public ModelAndView export(@PathVariable("filename") String filename, @PathVariable("suffix") String suffix, ModelMap modelMap) {
    ...
    modelMap.put(sheetName[0] + ".titles", new String[]{"报名时间","姓名","称谓","公司名","职位","邮箱","手机","证件类型","证件名称","证件号码","联系人姓名","联系人邮箱","联系人手机号","是否需要住宿","入住日期","离开日期","艾菲研讨会 Effie Seminar","自助午餐 Buffet Lunch","VIP欢迎晚宴 VIP Welcome Dinner","艾菲酒会 Effie Reception","红毯秀 Red Carpet Show","艾菲颁奖典礼 Effie Awards Gala","艾菲派对 Effie After Party","2016优秀案例赏析会 2016 Effie Forum","VIP午宴 VIP Luncheon","状态"});
    modelMap.put(sheetName[0] + ".fieldNames", new String[][]{{"createTime"},{"name"},{"salutation"},{"company"},{"title"},{"email"},{"mobile"},{"travelType"},{"travelName"},{"travelNo"},{"contactName"},{"contactEmail"},{"contactMobile"},{"isStay"},{"stayDate"},{"leaveDate"},{"schedule221"},{"schedule222"},{"schedule223"},{"schedule231"},{"schedule232"},{"schedule233"},{"schedule234"},{"schedule241"},{"schedule242"},{"hierarchy"}});
