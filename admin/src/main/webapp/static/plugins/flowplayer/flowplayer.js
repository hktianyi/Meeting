...
flowplayer(function(player, root) {
   ...
   var conf = player.conf,
      ...
      target = common.createElement('div',{ 'class': 'fp-embed-code'}, ''),
   ...
   player.embedCode = function() {
     ...
     var script = "var w=window,d=document,e;w._fpes||(w._fpes=[],w.addEventListener(\"load\",function(){var s=d.createElement(\"script\");s.src=\"" + _PATH + "/static/plugins/flowplayer/embed.min.js\",d.body.appendChild(s)})),e=[].slice.call(d.getElementsByTagName(\"script\"),-1)[0].parentNode,w._fpes.push({e:e,l:\"$library\",c:$conf});\n".replace('$conf', JSON.stringify(c)).replace('$library', embedConf.library || '');
...
extend(flowplayer, {
   ...
   defaults: {
      ...
      swf: _PATH + "/static/plugins/flowplayer/flowplayer.swf",
      swfHls: _PATH + "/static/plugins/flowplayer/flowplayerhls.swf",
