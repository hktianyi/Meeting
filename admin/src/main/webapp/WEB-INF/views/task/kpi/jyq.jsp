...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal form-row-seperated">
					<input type="hidden" name="tablename" value="6" /> 
					<input type="hidden" name="id" value="${data.id}" /> 
					<input type="hidden" name="status" id="status" value="${data.status}" />
					<div class="tablename">检疫犬经费支出绩效评价表</div>
					<table cellspacing="0" class="tableizer-table">
						<tr style=" font-weight:bold;">
							<td width="69" rowspan="2">一级指标</td>
							<td width="38" rowspan="2">权重</td>
							<td width="76" rowspan="2">二级指标 </td>
							<td width="36" rowspan="2">分值</td>
							<td width="153" rowspan="2">三级指标</td>
							<td width="50" rowspan="2">计量单位</td>
							<td width="49" rowspan="2">目标值(标准)</td>
							<td width="35" rowspan="2">分值</td>
							<td colspan="2">采集数据项</td>
							<td width="80" rowspan="2">指标值</td>
						</tr>
						<tr style=" font-weight:bold;">
							<td width="80">数据项1</td>
							<td width="80">数据项2</td>
						...
						<tr>
							...
							<td rowspan="2">30</td>
							<td style="text-align:left;">禁止进境物检疫犬截获率</td>
							<td>%</td>
							<td>20%</td>
							<td>15</td>
						...
						<tr>
							<td style="text-align:left;">有害生物检疫犬截获率</td>
							<td>%</td>
							<td>5%</td>
							<td>15</td>
						...
						<tr>
							...
							<td rowspan="2">20</td>
							<td style="text-align:left;">有效开箱率</td>
							<td>%</td>
							<td>50%</td>
							<td>10</td>
						...
						<tr>
							<td style="text-align:left;">在岗检疫犬考核合格率</td>
							<td>%</td>
							<td>50%</td>
							<td>10</td>
						...
						<tr>
							<td>产出成本</td>
							<td>20</td>
							<td style="text-align:left;">检疫犬生活费支出是否超出定额标准</td>
							<td>是/否</td>
							<td>否</td>
							<td>20</td>
						...
						<tr>
							...
							<td rowspan="20">25</td>
							<td rowspan="3">经济效益</td>
							<td rowspan="3">15</td>
							<td rowspan="3" style="text-align:left;">专项资金的投入是否提高了截获率</td>
							<td rowspan="3">是/否</td>
							<td rowspan="3">是</td>
							<td>5</td>
						...
						<tr>
							...
							<td rowspan="6">30</td>
							<td rowspan="6" style="text-align:left;">专项资金投入是否增加了公众对动植物检疫工作的认知度  专项资金的投入是否提高通关速度  </td>
							<td rowspan="3">是/否</td>
							<td rowspan="3">是</td>
							<td>5</td>
						...
						<tr>
							<td rowspan="3">环境效益</td>
							<td rowspan="3">15</td>
							<td rowspan="3" style="text-align:left;">专项资金投入是否可增强动植物有害生物随旅客携带物、邮寄物传入我国的防控能力，保护国内生态安全</td>
							<td rowspan="3">是/否</td>
							<td rowspan="3">是</td>
							<td>5</td>
						...
						<tr>
							<td rowspan="3">可持续影响</td>
							<td rowspan="3">15</td>
							<td rowspan="3" style="text-align:left;">专项资金投入是否对不法分子携带、邮寄禁止进境物入境形成一定的威慑力  </td>
							<td rowspan="3">是/否</td>
							<td rowspan="3">是</td>
							<td>5</td>
							<td rowspan="3"><input type="text" name="sj35"
						...
						<tr>
							<td rowspan="5">服务对象满意度</td>
							<td rowspan="5">25</td>
							<td rowspan="5" style="text-align:left;">入境旅客/机场/车站/客运码头/邮政运营管理单位对应用检疫犬查验邮包名录工作表现是否认同</td>
							<td rowspan="5">是/否</td>
							<td rowspan="5">是</td>
							<td>5</td>
							<td rowspan="5"><input type="text" name="sj36"
