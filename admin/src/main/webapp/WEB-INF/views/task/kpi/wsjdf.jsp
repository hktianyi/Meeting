...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal form-row-seperated">
					<input type="hidden" name="tablename" value="12" /> 
					<input type="hidden" name="id" value="${data.id}" /> 
					<input type="hidden" name="status" id="status" value="${data.status}" />
					<div class="tablename">外事接待费专项经费绩效评价表</div>
					<table cellspacing="0" class="tableizer-table">
						...
						<tr>
							<td rowspan="6">项目产出</td>
							<td rowspan="6">25</td>
							<td rowspan="2">产出数量</td>
							<td rowspan="2">30</td>
							<td style="text-align:left;">外事接待任务完成率</td>
							<td>%</td>
							<td>100%</td>
							<td>15</td>
						...
						<tr>
							<td style="text-align:left;">是否促进国际合作项目增长</td>
							<td>是/否</td>
							<td>是</td>
							<td>15</td>
						...
						<tr>
							...
							<td rowspan="2">30</td>
							<td style="text-align:left;">外事接待任务是否达到预期目的</td>
							<td>是/否</td>
							<td>是</td>
							<td>15</td>
						...
						<tr>
							<td style="text-align:left;">是否保障了外事工作的开展</td>
							<td>是/否</td>
							<td>是</td>
							<td>15</td>
						...
						<tr>
							<td>产出时效</td>
							<td>20</td>
							<td style="text-align:left;">是否保障国外代表团正常工作</td>
							<td>是/否</td>
							<td>是</td>
							<td>20</td>
						...
						<tr>
							<td>产出成本</td>
							<td>20</td>
							<td style="text-align:left;">外事接待是否超出标准</td>
							<td>是/否</td>
							<td>否</td>
							<td>20</td>
						...
						<tr>
							...
							<td rowspan="6">30</td>
							<td rowspan="2" style="text-align:left;">促进外向型经济发展，维护出口产品质量的声誉</td>
							<td rowspan="2">是/否</td>
							<td rowspan="2">是</td>
							<td>5</td>
						...
						<tr>
							<td rowspan="2" style="text-align:left;">是否提高了检验检疫的影响力</td>
							<td rowspan="2">是/否</td>
							<td rowspan="2">是</td>
							<td>5</td>
						...
						<tr>
							<td rowspan="2" style="text-align:left;">是否提高国际交流合作效果，促进交流与合作科研 </td>
							<td rowspan="2">是/否</td>
							<td rowspan="2">是</td>
							<td>5</td>
						...
						<tr>
							<td rowspan="2" style="text-align:left;">是否有助于检验检疫对外政策宣传 </td>
							<td rowspan="2">是/否</td>
							<td rowspan="2">是</td>
							<td>5</td>
						...
						<tr>
							...
							<td rowspan="2">10</td>
							<td rowspan="2" style="text-align:left;">来访外宾是否满意</td>
							<td rowspan="2">是/否</td>
							<td rowspan="2">是</td>
							<td>5</td>
							<td rowspan="2"><input type="text" name="sj310"
								value="${data.sj310}" style="width:98%; height:100%;" /></td>
							<td colspan="2" style="text-align:left;">①<input type="text"
								name="ly3101" value="${data.ly3101}"
								style="width:93%;height:135%;" /></td>
						</tr>
						<tr>
							<td>5</td>
							<td colspan="2" style="text-align:left;">②<input type="text"
								name="ly3102" value="${data.ly3102}"
								style="width:93%;height:135%;" /></td>
						</tr>
						<tr style=" font-weight:bold;">
							<td>总分</td>
